 ...
 */
public final class ScriptOptionUtil {
    ...
    public static String getString(Map<String, Object> map, String defaultValue, String... keys) {
    ...
    public static String getRequiredString(Map<String, Object> map, String... keys) {
    ...
    public static int getInt(Map<String, Object> map, int defaultValue, String... keys) {
        Object value = get(map, keys);
        if (value == null) {
            return defaultValue;
        }
    ...
    public static long getLong(Map<String, Object> map, long defaultValue, String... keys) {
        Object value = get(map, keys);
        if (value == null) {
            return defaultValue;
        }
