...
final class MessageKeys {
    ...
    static final String TOOLBOX_REDIS_AUTH = "toolbox.redis.auth";
    static final String TOOLBOX_REDIS_AUTH_NONE = "toolbox.redis.auth.none";
    static final String TOOLBOX_REDIS_AUTH_BASIC = "toolbox.redis.auth.basic";
    ...
    static final String TOOLBOX_REDIS_PROFILE = "toolbox.redis.profile";
    static final String TOOLBOX_REDIS_PROFILE_NEW = "toolbox.redis.profile.new";
    ...
    static final String TOOLBOX_REDIS_PROFILE_DELETED = "toolbox.redis.profile.deleted";
    static final String TOOLBOX_REDIS_PROFILE_DELETE_CONFIRM = "toolbox.redis.profile.delete.confirm";
    static final String TOOLBOX_REDIS_PROFILE_DELETE_CONFIRM_TITLE = "toolbox.redis.profile.delete.confirm.title";
    static final String TOOLBOX_REDIS_PROFILE_NOT_SELECTED = "toolbox.redis.profile.not_selected";
    static final String TOOLBOX_REDIS_PROFILE_DEFAULT_NOT_DELETABLE = "toolbox.redis.profile.default_not_deletable";
    static final String TOOLBOX_REDIS_PROFILE_NAME_REQUIRED = "toolbox.redis.profile.name.required";
    static final String TOOLBOX_REDIS_PROFILE_NAME_EXISTS = "toolbox.redis.profile.name.exists";
